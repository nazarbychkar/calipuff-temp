      ...
      <div className="flex flex-col lg:flex-row justify-between m-5 lg:m-10 gap-10">
        <div className="w-full lg:w-96 lg:h-72 relative">
          ...
          <div className="mt-4 text-lg lg:text-2xl font-normal font-['Poppins'] leading-relaxed">
            Зібрали відповіді про ароматичні девайси,
            <br />
            поставки та якість {BRAND.name}
          </div>
        </div>
          ...
          {[
            {
              ...
              content:
                "Приймаємо банківські картки, рахунок-фактуру для компаній та еквайринг. Партнерські замовлення від 10 одиниць підтверджуємо 50% передоплатою.",
            },
            {
              number: "02",
            ...
            {
              number: "03",
              title: `Якість та безпека | ${BRAND.name}`,
              content:
                "Всі продукти проходять контроль якості та сертифікацію. Посилання на лабораторні звіти додаємо в особистому кабінеті партнера або за запитом.",
            },
            {
              number: "04",
