...
const PLACEHOLDER_REVIEWS = [
  {
    id: 1,
    name: "Олександр К.",
    text: "Найкращі ароматичні девайси, які я коли-небудь використовував! Аромати справді каліфорнійські, а якість на висоті. Рекомендую всім!",
    rating: 5,
  },
  {
    id: 2,
  ...
  },
  {
    id: 4,
    name: "Анна П.",
    text: "Аромати просто неймовірні! Особливо подобаються солодкі хвилі. Сертифікація дає впевненість у якості.",
    rating: 5,
  },
  {
    id: 5,
