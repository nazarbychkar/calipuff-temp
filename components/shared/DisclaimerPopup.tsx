    ...
    >
      <div className="bg-white rounded-lg shadow-2xl border border-gray-200 p-4 sm:p-6 space-y-4">
        <div className="text-xs sm:text-sm text-gray-700 leading-relaxed">
          <p>
            Уся продукція, представлена на нашому сайті, призначена виключно для ароматичного використання та не є тютюновим виробом, не містить нікотину й психоактивних речовин. Продукція доступна лише для повнолітніх користувачів 18+.
          </p>
        </div>
        <button
