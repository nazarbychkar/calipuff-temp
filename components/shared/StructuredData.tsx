        ...
        return {
          ...
          "mainEntity": [
            ...
            },
            {
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Всі рідини та картриджі не містять ТГК і мають COA. Посилання на лабораторні звіти додаємо в особистому кабінеті партнера або за запитом."
              }
            },
            {
              "@type": "Question",
          ...
          "review": [
            {
              ...
              "reviewBody": "Найкращі вейпи, які я коли-небудь пробував! Смаки справді каліфорнійські, а якість на висоті. Рекомендую всім!"
            },
            {
              "@type": "Review",
              "author": {
