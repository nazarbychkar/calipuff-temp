...
export const metadata: Metadata = {
  title: "Договір публічної оферти | cali aroma devices",
  description: "Договір публічної оферти cali aroma devices",
};
            ...
            <div className="space-y-4">
              <div className="p-5 border border-black/10 dark:border-white/10 rounded-lg space-y-2">
                ...
                <p className="text-sm opacity-70">
                  ...
                  https://calishops.com, включаючи всі його веб-сторінки.
                </p>
              </div>
              <div className="p-5 border border-black/10 dark:border-white/10 rounded-lg space-y-2">
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-3">
              <p className="opacity-80">
                ...
                текстову інформацію про артикул, доступні смаки, ціну.
              </p>
              <p className="opacity-80">
